...
class SemanaryView(BrowserView):
    ...
    def imgPosters(self):
        academicas = api.content.get(path='/inicio/1/1/posters')
        divulgacion = api.content.get(path='/inicio/1/2/slider')
        return academicas.queryCatalog() + divulgacion.queryCatalog()
