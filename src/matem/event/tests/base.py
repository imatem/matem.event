...
def setup_product():
    ...
    import matem.event
    zcml.load_config('configure.zcml', matem.event)
    ...
    ztc.installPackage('matem.event')
    ztc.installPackage('p4a.ploneevent')
...
setup_product()
ptc.setupPloneSite(products=['matem.event', 'p4a.ploneevent'])
